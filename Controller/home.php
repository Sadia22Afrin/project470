...
<?php include '../View/UI.php';?>
  ...
  <body>
	...
	<section id = "section1">
		<div class="col-md-10" style="text-align: center; font-size: 100px; color:#2d2244"> S Airways </div><br><br><br>
		...
		<form action="../Model/signin_process.php" class="form_design" method="post" style="color:White">
			<div class="col-md-10" style="text-align: center; font-size: 25px; color:#659891">
